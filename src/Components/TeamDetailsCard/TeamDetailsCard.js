...
const TeamDetailsCard = (props) => {
    const { team } = props
    const { strTeam, intFormedYear, strSport, strStadiumThumb, strTeamBadge, strDescriptionEN, strDescriptionDE, strWebsite, strFacebook, strTwitter, strInstagram, strCountry, strGender, strYoutube } = team;
    return (
        <div >
            ...
            <div className='row  mt-3 container mx-auto  ' style={{ backgroundColor: 'revert' }}>
                <Card className="col-md-7 bg-danger border-0" >
